...
namespace Smarteye.RestAPI
{
    public class RestAPI : MonoBehaviour
    {
        ...
        public void PostAction(Dictionary<string, object> _data, Action<JObject> success, Action<JObject> err, string _endpointTitle, string uniqValue = "")
        {
            ...
            string fullUri = targetAPIConfig.url + targetAPIConfig.GetEndpoint(_endpointTitle) + uniqValue;
        ...
        {
            string fullUri = targetAPIConfig.url + targetAPIConfig.GetEndpoint(_endpointTitle) + patchData;
        ...
        {
            string uri = targetAPIConfig.url + targetAPIConfig.GetEndpoint(_endpointTitle);
        ...
        {
            string uri = targetAPIConfig.url + targetAPIConfig.GetEndpoint(_endpointTitle) + id;
            StartCoroutine(GetWithAuthCoroutine(uri, targetAPIConfig.username, targetAPIConfig.password, success, err));
        }
